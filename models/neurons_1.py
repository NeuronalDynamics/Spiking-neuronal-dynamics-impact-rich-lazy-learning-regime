...
from utils.types_1 import NeuronParameters, StructureParameters
...
class GLIFR(nn.Module):
        ...
        def hom_init_(self):
                with torch.no_grad():
                        ...
                        print(self.k_m)
                        print("------------------------------------------------------------------------------------")
                        nn.init.constant_(self.trans_k_m, math.log(self.dt * self.k_m / (1 - (self.dt * self.k_m))))
                        ###########################################################################################################
