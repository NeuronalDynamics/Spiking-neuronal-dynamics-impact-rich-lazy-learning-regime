...
class GLIFRN(BaseModule):
        ...
        def get_weights(self):
            # Return input weights and lateral weights as a tuple or a combined form
            return self.neuron_layer.weight_iv, self.neuron_layer.weight_lat

        def spike_fn(self, x):
            return self.neuron_layer.spike_fn(x)

        def spike_fn_derivative(self, x):
            return self.neuron_layer.spike_fn_derivative(x)
        ...
        def init_states(self, batch_size):
                return self.neuron_layer.init_states(batch_size)
